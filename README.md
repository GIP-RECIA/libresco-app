...
- Flutter `3.38.9`
- Dart `3.10.8` (integrated to the Flutter SDK)
...
_Optional :_ If you open and work on the project with Android Studio, you can optionally install the Flutter et Dart plugins.
