      ...
      child: SingleChildScrollView(
        ...
        <html>
          ...
          <body style="margin:0; padding:10px; font-family:sans-serif;">
            <r-widgets-wrapper localization-uri="/commun/widgets-wrapper/20250828/i18n.json" soffit-uri="/portail/api/v5-1/userinfo?claims=private,ENTPersonGARIdentifiant,ESCOUAICourant,ESCOUAI,ENTPersonProfils&amp;groups=" widget-max-count="3" get-prefs-uri="/portail/api/prefs/getentityonlyprefs/Widgets" put-prefs-uri="/portail/api/prefs/putprefs?fname=Widgets" adapter-source-uri="/resource-server/webjars/gip-recia__widgets-to-endpoints-adapter/dist/widgets-to-endpoints-adapter.js" adapter-config-uri="/commun/widgets-to-endpoints-adapter/20250828/adapter-configuration.json">
            </r-widgets-wrapper>
