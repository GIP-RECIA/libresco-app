...
- Les tests d'intégrations ont été configurés pour fonctionner sur Android mais pas encore sous IOS (voir https://patrol.leancode.co/documentation à l'étape 5)
